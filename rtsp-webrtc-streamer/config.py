...
# CP Plus/Dahua-style RTSP stream. Override this in .env if the camera uses
# authentication or a different channel/subtype path.
CAMERA_SOURCE_URL = os.environ.get(
    "CAMERA_SOURCE_URL",
    "rtsp://10.23.0.220:554/cam/realmonitor?channel=1&subtype=0",
)
